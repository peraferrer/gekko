...
method.init = function() {
  ...
  this.addTulipIndicator('shortEMA', 'ema', {optInTimePeriod : this.settings.shortSize});
  this.addTulipIndicator('longEMA', 'ema', {optInTimePeriod : this.settings.longSize});
...
// EMAs and diff.
method.log = function() {
  var shortEMA = this.tulipIndicators.shortEMA;
  var longEMA = this.tulipIndicators.longEMA;
...
method.check = function(candle) {
  ...
  var shortResult = this.tulipIndicators.shortEMA.result.outReal;
  var longResult = this.tulipIndicators.longEMA.result.outReal;
